...
extern Space_Object_t asteroid[ASTEROID_BUFFER_SIZE];
extern Space_Object_t rocket[ROCKET_BUFFER_SIZE];

extern vector asteroidVector;
extern vector rocketVector;

extern uint8_t currentWave;
extern uint8_t numOfAsteroidInWave[NUM_OF_WAVE];
...
//	oled_display();
//	generate_randomNumber(&randomNumber);
